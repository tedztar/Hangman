...
def game():
    ...
    #makes the 'answer' in the correct format (_ _ _)
...
#asks the user to select the amount of games they would like
while games == 0:
    try:
        games = int(input("How many games would you like to play? (Max 10) "))
        if games > 10 or games < 1:
            print("Please choese a number of games between 1 and 10.")
            games = 0
    except ValueError:
        print ("Oops!  That was no valid number.  Try again...")

#runs the ammountof 'games' the user wants.
while games != 0:
    game()
    games -= 1
